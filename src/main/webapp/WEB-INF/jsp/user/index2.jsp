...
<body>
						...
						<div class="table-responsive">
							<table class="table  table-bordered">
								<thead>
									<tr>
										<th width="50">序号</th>
										<th width="45" style="text-align: center"><input
											type="checkbox"></th>
									...
									<tr>
										<td colspan="6" align="center">
											<ul class="pagination">
												...
												<c:if test="${page>1}">
													<li><a href="#" onclick="changePageNum(${page-1})">上一页</a></li>
												</c:if>
												<!-- 显示中间的页码数 -->
												<c:forEach begin="1" end="${maxPage}" varStatus="status">
													...
													<c:if test="${page!=status.count}">
														<li>
														<a href="#" onclick="changePageNum(${status.count})">${status.count}</a>
														</li>
													</c:if>
												</c:forEach>
												<!-- 规定下一页是否可用 -->
												<c:if test="${page<maxPage}">
													<li><a href="#" onclick="changePageNum(${page+1})">下一页</a></li>
												</c:if>
												<c:if test="${page==maxPage}">
	...
	<script type="text/javascript">
		...
		function changePageNum(pageNum){
			window.location.href="${APP_PATH}/user/index?page="+pageNum;
		}
	</script>
</body>
</html>
