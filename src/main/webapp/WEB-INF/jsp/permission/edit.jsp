						...
						<form role="form">
							<div class="form-group">
								<label for="exampleInputPassword1">许可名称</label> <input
									type="text" class="form-control" id="perName"
									placeholder="请输入许可名称">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">链接地址</label> <input type="email"
									class="form-control" id="url" placeholder="请输入链接地址">
							</div>
			...
			$('#insertBtn').click(function(){
				...
				$.ajax({
				    ...
				    success:function(result){
				    	...
				    	if(result.success){
							layer.msg("许可信息添加成功！",{time:2000,icon:6,shift:5},function(){ 
							});
							window.location.href="${APP_PATH}/permission/index";
				    	}else{
							layer.msg("许可信息添加失败！",{time:2000,icon:5,shift:5},function(){ 
							});	
				    	}
				    }
				});
